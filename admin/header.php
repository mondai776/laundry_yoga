...
<head>
    ...
    <link rel="icon" href="../assets/img/bg3.png" type="" />
        ...
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="purple">
                ...
                <a href="index.html" class="logo">
                    <img src="../assets/img/bg3.png" width="70" mt-2 alt="navbar brand" class="navbar-brand">
                </a>
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        <li class="nav-item dropdown hidden-caret">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                                <div class="avatar-sm">
                                    <img src="../assets/img/yoga.jpg" alt="..." class="avatar-img rounded-circle">
                                </div>
                            </a>
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg"><img src="../assets/img/yoga.jpg" alt="image profile" class="avatar-img rounded"></div>
                                            <div class="u-text">
